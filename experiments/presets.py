...
REPLAY_LATENT_DISAGREEMENT_CFG = {
    ...
    "agent.intrinsic.exploration_type": "state_disagreement", # state_disagreement, reward_variance
    "agent.intrinsic.reward_type": "disagreement", # prediction_error, disagreement, max_disagreement
}

REPLAY_LATENT_DISAGREEMENT_CFG_EMA = {
    "logdir": r"~/logdir/latent_reward_disagreement/{timestamp}", 
    "run.train_ratio": 32,
    "run.log_every": 10,
    "run.save_every": 10000,
...
REPLAY_LATENT_DISAGREEMENT_CFG_EXP_DECAY = {
    "logdir": r"~/logdir/latent_reward_disagreement/{timestamp}", 
    "run.train_ratio": 32,
    "run.log_every": 10,
    "run.save_every": 10000,
